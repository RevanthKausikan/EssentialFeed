...
fileprivate final class MainQueueDisatchDecorator<T> {
...
extension MainQueueDisatchDecorator: FeedLoader where T == FeedLoader {
...
extension MainQueueDisatchDecorator: FeedImageDataLoader where T == FeedImageDataLoader {
...
fileprivate final class FeedImageDataLoaderPresentationAdapter<View: FeedImageView, Image>: FeedImageCellControllerDelegate where View.Image == Image {
